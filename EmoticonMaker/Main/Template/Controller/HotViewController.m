...
- (void)loadData {
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://api.jiefu.tv/app2/api/dt/item/hotList.html?pageNum=%li&pageSize=48", _pageNum];
...
-(void)createCollectionView {
    ...
    [_collectionView addPullDownRefreshBlock:^{
        __strong HotViewController *strongSelf = weakSelf;
