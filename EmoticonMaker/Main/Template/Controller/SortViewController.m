...
- (void)loadData {
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://api.jiefu.tv/app2/api/dt/item/getByTag.html?tagId=%li&pageNum=%li&pageSize=48",_emoticonId, _pageNum];
...
-(void)createCollectionView {
    ...
    [_collectionView addPullDownRefreshBlock:^{
        __strong SortViewController *strongSelf = weakSelf;
